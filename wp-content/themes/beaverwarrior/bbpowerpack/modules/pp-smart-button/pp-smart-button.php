 ...
 *
 * Extended version from ~/modules/pp-smart-button/ in BeaverPowerPack plugin
 */
...
FLBuilder::register_module('PPSmartButtonModule', array(
	...
	'event_tracking' => array(
		'title'      => __('Event Tracking', 'bb-powerpack'),
		'sections'      => array(
			'general'         => array(
				'title'         => "Use event tracking",
				'fields'        => array(
					'event_tracking_enabled' => array(
						'type'          => 'pp-switch',
						'label'         => false,
						'default'       => false,
						'options'       => array(
							false => __('Disabled', 'bb-powerpack'),
							true  => __('Enabled', 'bb-powerpack')
						),
						'toggle'		=> array(
							true		=> array(
			...
			'event_tracking_values' => array(
				'label'         => "Event tracking values",
				'fields'        => array(
					'event_tracking_category'	=> array(
						'type'        => 'text',
						'label'       => 'Category',
						'placeholder' => 'Event Category (Required)',
						'help'        => 'Typically the object that was interacted with (e.g. \'Video\')'
					),
					'event_tracking_action'		=> array(
						'type'        => 'text',
						'label'       => 'Action',
						'placeholder' => 'Event Action (Required)',
						'help'        => 'The type of interaction (e.g. \'play\')'
					),
					'event_tracking_label'	=> array(
						'type'	=> 'text',
						'label'	=> 'Label',
						'placeholder' => 'Event Label',
						'help'  => 'Useful for categorizing events (e.g. \'Fall Campaign\')'
					),
					'event_tracking_value'	=> array(
						'type'	=> 'unit',
						'label'	=> 'Value',
						'help'  => 'A numeric value associated with the event (e.g. 42)'
					)
				)
			)
		)
