...
$settings->post_font_size = UABB_Helper::uabb_colorpicker($settings, "post_font_size");
$settings->post_line_height = UABB_Helper::uabb_colorpicker($settings, "post_line_height");
