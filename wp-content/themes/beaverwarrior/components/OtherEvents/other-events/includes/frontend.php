    ...
    <div class="OtherEvents-banner <?php echo $displaynoneo, $other_events->other_events_type?>" data-sort="<?php echo $dataDate?>" id="bw-other-banner-<?php echo esc_attr($id); ?>">
      ...
      <div class="OtherEvents-details">
        ...
        <div class="OtherEvents-link_button fl-button-wrap fl-button-width-auto fl-button-has-icon">
			<a href="<?php echo $other_events->other_events_link ?>" target="_blank" class="fl-button OtherEvents-link" role="button" rel="noopener">
							<span class="OtherEvents-link_text fl-button-text"><?php echo $other_events->other_events_link_button ?></span>
						<i class="OtherEvents-link_icon fl-button-icon icon-arrowright-up" aria-hidden="true"></i>
			</a>
