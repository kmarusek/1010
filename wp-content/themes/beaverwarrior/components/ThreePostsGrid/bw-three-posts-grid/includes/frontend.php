                ...
                <div class="ThreePostsGrid-share-date-wrap">
                    ...
                    <div class="ThreePostsGrid-share-btn_wrap">
                        ...
                        <div class="ThreePostsGrid-share-container">
                            ...
                            <a href="https://twitter.com/share?url=<?php echo $post_url;?>&text=<TEXT>via=<USERNAME>"><i class="ThreePostsGrid-share-icon twitter <?php echo $settings->posts_share_twitter_icon; ?>" ></i></a>
                            <a href="mailto:?subject=Checkout%20out%20this%20story&body=<?php echo $post_url;?>"><i class="ThreePostsGrid-share-icon email <?php echo $settings->posts_share_email_icon; ?>" ></i></a>
                        </div>
                    </div>
                </div>
            </div>
