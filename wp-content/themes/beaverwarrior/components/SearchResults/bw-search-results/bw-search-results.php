                ...
                'section_typography_post_categories' => array(
                    ...
                    'fields' => array(
                        'post_categories_typography' => array(
                            ...
                            'preview' => array(
                                'type'     => 'css',
                                'selector' => '.SearchResults-categories'
                            )
                        ),
                ...
                'section_typography_excerpt' => array(
                    ...
                    'fields' => array(
                        'post_excerpt_typography' => array(
                            ...
                            'preview' => array(
                                'type'     => 'css',
                                'selector' => '.SearchResults-excerpt'
                            )
                        ),
                ...
                'section_spacing' => array(
                    ...
                    'fields' => array(
                        'post_categories_margin_bottom' => array(
                            ...
                            'preview'      => array(
                                'type'      => 'css',
                                'selector'  => '.SearchResults-category-container',
                                'property'  => 'margin-bottom'
                            )
                        ),
                        'post_title_margin_bottom' => array(
                            ...
                            'preview'      => array(
                                'type'     => 'css',
                                'selector' => '.SearchResults-title-container',
                                'property' => 'margin-bottom'
                            )
                        ),
                        'post_excerpt_margin_bottom' => array(
                            ...
                            'preview' => array(
                                'type'     => 'css',
                                'selector' => '.SearchResults-excerpt-container',
                                'property' => 'margin-bottom'
                            )
                        ),
                        'post_date_margin_bottom' => array(
                            ...
                            'preview' => array(
                                'type'     => 'css',
                                'selector' => '.SearchResults-post-date-container',
                                'property' => 'margin-bottom'
                            )
                        )
                    )
