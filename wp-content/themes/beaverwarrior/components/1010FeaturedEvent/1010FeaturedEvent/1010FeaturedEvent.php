<?php
/**
 * @class BW1010FeaturedEvents
 *
 */
class BW1010FeaturedEvent extends BeaverWarriorFLModule {
    ...
    public function __construct(){
        FLBuilderModule::__construct(
            [
                'name'            => __('Featured Events', 'skeleton-warrior'),
                'description'     => __('Featured Events Module', 'fl-builder'),
...
FLBuilder::register_module('BW1010FeaturedEvent', array(
    ...
    'events_spacing' => array (
        ...
        'sections' => array (
            'card_margin' => array (
                ...
                'fields' => array (
                    'featured_event_margin' => array(
                        ...
                        'preview' => array(
                            'type'      => 'css',
                            'selector'  => '.TenTenFeaturedEvent-post',
                            'property'  => 'margin'
                        )
                    ),
                    'event_padding' => array(
            ...
            'content_margin' => array (
                'title' => __( 'Featured Event Content Margins', 'fl-builder'),
                'fields' => array (
                    'date_margin' => array(
                        'type'         => 'dimension',
