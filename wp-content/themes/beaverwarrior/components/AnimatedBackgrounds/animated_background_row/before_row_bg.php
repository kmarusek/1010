<ul data-scrollalax data-scrollalax-depthrange="inside"<?php if ($rows->settings->bw_ab_loadanim === "yes") { ?> data-scrolleffects-loadanimation="true"<?php } ?> class="AnimatedBackgrounds is-ScrollEffects--indeterminate">
