<div class="AnimatedBackgrounds-standalone_wrapper">
    <div class="AnimatedBackgrounds-standalone" style="position: relative; padding-top: <?php echo 1 / floatval($settings->aspect_ratio) * 100; ?>%">
        <ul data-scrollalax data-scrollalax-depthrange="inside" class="AnimatedBackgrounds is-ScrollEffects--indeterminate"<?php if ($settings->bw_ab_loadanim === "yes") { ?> data-scrolleffects-loadanimation="true"<?php } ?>>
