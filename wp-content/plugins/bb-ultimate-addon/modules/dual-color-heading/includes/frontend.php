<div class="uabb-module-content uabb-dual-color-heading <?php echo $settings->dual_color_alignment; ?> <?php echo $settings->responsive_compatibility; ?>">
	...
	?>
	<span class="uabb-first-heading-text"><?php echo $settings->first_heading_text; ?></span><span class="uabb-second-heading-text"><?php echo $settings->second_heading_text; ?></span>
