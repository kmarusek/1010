<div class="uabb-module-content uabb-before-after-slider">
	<div class="uabb-module-content before-after-slider">
		<div class="uabb-ba-container baslider-<?php echo $module->node; ?> uabb-label-position-<?php echo ( $settings->before_after_orientation != 'vertical' ) ? $settings->slider_label_position : $settings->slider_vertical_label_position; ?> <?php echo ( $settings->move_on_hover == 'true' ) ? 'uabb-move-on-hover' : ''; ?>" 
															<?php
															if ( isset( $settings->before_after_orientation ) && $settings->before_after_orientation == 'vertical' ) {
