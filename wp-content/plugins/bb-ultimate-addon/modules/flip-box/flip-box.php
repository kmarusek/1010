    ...
    function render_new_data( $data ) {
		...
		foreach ( $data as &$node ) {
			...
			if ( isset( $node->settings->type ) && 'flip-box' === $node->settings->type ) {
				...
				if( isset( $node->settings->back_title_typography_line_height['medium']) && isset( $node->settings->back_title_typography_font_size['small'] ) && $node->settings->back_title_typography_font_size['medium'] != 0 && !isset( $node->settings->back_title_typography_line_height_unit_medium ) ) {
                    if( is_numeric( $node->settings->back_title_typography_line_height['medium']) && is_numeric( $node->settings->back_title_typography_font_size['small'] ) )
				...
				if( isset( $node->settings->back_title_typography_line_height['desktop']) && isset( $node->settings->back_title_typography_font_size['small'] ) && $node->settings->back_title_typography_font_size['desktop'] != 0 && !isset( $node->settings->back_title_typography_line_height_unit ) ) {
                    if( is_numeric( $node->settings->back_title_typography_line_height['desktop']) && is_numeric( $node->settings->back_title_typography_font_size['small'] ) )
				...
				if( isset( $node->settings->back_desc_typography_line_height['medium']) && isset( $node->settings->back_desc_typography_font_size['small'] ) && $node->settings->back_desc_typography_font_size['medium'] != 0 && !isset( $node->settings->back_desc_typography_line_height_unit_medium ) ) {
                    if( is_numeric( $node->settings->back_desc_typography_line_height['medium']) && is_numeric( $node->settings->back_desc_typography_font_size['small'] ) )
				...
				if( isset( $node->settings->back_desc_typography_line_height['desktop']) && isset( $node->settings->back_desc_typography_font_size['small'] ) && $node->settings->back_desc_typography_font_size['desktop'] != 0 && !isset( $node->settings->back_desc_typography_line_height_unit ) ) {
                    if( is_numeric( $node->settings->back_desc_typography_line_height['desktop']) && is_numeric( $node->settings->back_desc_typography_font_size['small'] ) )
