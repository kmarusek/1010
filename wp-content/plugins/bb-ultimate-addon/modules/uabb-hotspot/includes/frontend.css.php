		...
		for( $i = 0; $i < count( $settings->hotspot_marker ); $i++ ) {
			...
			<?php
		 	...
		 	?>
			 	...
			 	.fl-node-<?php echo $id; ?> .uabb-hotspot-item-<?php echo $i; ?> .uabb-hotspot-text {
			 		...
			 		<?php 
			 		if( isset( $settings->hotspot_marker[$i]->text_typography_padding ) && $settings->hotspot_marker[$i]->text_typography_padding != '' && isset( $settings->hotspot_marker[$i]->text_typography_padding_dimension_top ) && ( $settings->hotspot_marker[$i]->text_typography_padding_dimension_top == '' || $settings->hotspot_marker[$i]->text_typography_padding_dimension_top == '0' ) && isset( $settings->hotspot_marker[$i]->text_typography_padding_dimension_bottom ) && ( $settings->hotspot_marker[$i]->text_typography_padding_dimension_bottom == '' || $settings->hotspot_marker[$i]->text_typography_padding_dimension_bottom == '0' ) && isset( $settings->hotspot_marker[$i]->text_typography_padding_dimension_left ) && ( $settings->hotspot_marker[$i]->text_typography_padding_dimension_left == '' || $settings->hotspot_marker[$i]->text_typography_padding_dimension_left == '0' ) && isset( $settings->hotspot_marker[$i]->text_typography_padding_dimension_right ) && ( $settings->hotspot_marker[$i]->text_typography_padding_dimension_right == '' || $settings->hotspot_marker[$i]->text_typography_padding_dimension_right == '0' ) ) {
			...
			?>
				...
				.fl-node-<?php echo $id; ?> .uabb-hotspot-item-<?php echo $i; ?> .uabb-hotspot-tooltip-content {
					...
					<?php 
					if( isset( $settings->hotspot_marker[$i]->tooltip_padding ) && $settings->hotspot_marker[$i]->tooltip_padding != '' && isset( $settings->hotspot_marker[$i]->tooltip_padding_dimension_top ) && ( $settings->hotspot_marker[$i]->tooltip_padding_dimension_top == '' || $settings->hotspot_marker[$i]->tooltip_padding_dimension_top == '0' ) && isset( $settings->hotspot_marker[$i]->tooltip_padding_dimension_bottom ) && ( $settings->hotspot_marker[$i]->tooltip_padding_dimension_bottom == '' || $settings->hotspot_marker[$i]->tooltip_padding_dimension_bottom == '0' ) && isset( $settings->hotspot_marker[$i]->tooltip_padding_dimension_left ) && ( $settings->hotspot_marker[$i]->tooltip_padding_dimension_left == '' || $settings->hotspot_marker[$i]->tooltip_padding_dimension_left == '0' ) && isset( $settings->hotspot_marker[$i]->tooltip_padding_dimension_right ) && ( $settings->hotspot_marker[$i]->tooltip_padding_dimension_right == '' || $settings->hotspot_marker[$i]->tooltip_padding_dimension_right == '0' ) ) {
