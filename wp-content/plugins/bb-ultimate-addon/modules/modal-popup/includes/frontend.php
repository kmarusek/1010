<div <?php echo ( $settings->id != '' ) ? 'id="' . $settings->id . '-overlay"' : ''; ?> class="uabb-modal-parent-wrapper uabb-module-content uamodal-<?php echo $id; ?> <?php echo ( $settings->class != '' ) ? $settings->class . '-overlay' : ''; ?>">
	<div class="uabb-modal uabb-drag-fix uabb-center-modal uabb-modal-<?php echo $settings->content_type; ?> uabb-modal-custom<?php // echo $settings->modal_size; ?> <?php echo $settings->modal_effect; ?> uabb-aspect-ratio-<?php echo $settings->video_ratio; ?>" id="modal-<?php echo $id; ?>" data-content="<?php echo $settings->content_type; ?>">
		<div class="uabb-content <?php // echo ( $settings->content_type == 'content' ) ? 'uabb-text-editor' : ''; ?>">
			...
			<span class="uabb-modal-close uabb-close-custom<?php // echo $settings->modal_size; ?>-<?php echo $settings->icon_position; ?>" >
																											<?php
