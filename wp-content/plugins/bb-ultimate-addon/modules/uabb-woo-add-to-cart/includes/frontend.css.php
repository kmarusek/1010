...
<?php } else if ( 'right' == $settings->btn_align ) { ?>
	.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button {
		margin-left: auto;
		margin-right: 0;
	}
<?php } else if ( 'center' == $settings->btn_align ) { ?>
	.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button {
		margin-left: auto;
		margin-right: auto;
	}
<?php } else if ( 'justify' == $settings->btn_align ) { ?>
	.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button {
		width: 100%;
	}
<?php } ?>
...
.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button {
	...
	<?php  
	if( $settings->font_family['family'] !== 'Default' ) {
...
?>	
	...
	.fl-node-<?php echo $id; ?> a.uabb-creative-transparent-btn.uabb-none-btn:hover .uabb-atc-icon-align {
		<?php if ( $settings->text_hover_color != "" && $settings->text_hover_color != "FFFFFF" ) { ?>
...
<?php if($global_settings->responsive_enabled) { ?> 
        ...
        @media ( max-width: <?php echo $global_settings->responsive_breakpoint .'px'; ?> ) {
			...
			<?php } else if ( 'right' == $settings->mobile_align ) { ?>
				.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button{
					margin-left: auto;
					margin-right: 0;
					width: auto;
				}
			<?php } else if ( 'center' == $settings->mobile_align ) { ?>
				.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button{
					margin-left: auto;
					margin-right: auto;
					width: auto;
				}
			<?php } else if ( 'justify' == $settings->mobile_align ) { ?>
				.fl-node-<?php echo $id; ?> .uabb-woo-add-to-cart .button {
					width: 100%;
				}
			<?php } ?>
