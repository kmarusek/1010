...
<div class="pp-3d-slider pp-user-agent-<?php echo pp_get_user_agent(); ?>">
    ...
    <?php if ( 'no' == $settings->autoplay ) { ?>
        <nav class="pp-slider-nav">
    		<span class="pp-slider-nav-button pp-slider-prev"><?php pp_prev_icon_svg( __( 'Previous', 'bb-powerpack' ) ); ?></span>
    		<span class="pp-slider-nav-button pp-slider-next"><?php pp_next_icon_svg( __( 'Next', 'bb-powerpack' ) ); ?></span>
    	</nav>
    <?php } ?>
</div>
