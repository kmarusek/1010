		...
		<div class="pp-photo-content<?php echo $class; ?>">
			<div class="pp-photo-content-inner">
				...
				<?php } ?>
					...
					<?php if ( $photo && ! empty( $photo->caption ) && 'never' != $settings->show_caption ) { ?>
						<div class="pp-photo-caption pp-photo-caption-<?php echo $settings->show_caption; ?>" itemprop="caption"<?php echo $width ? ' style="max-width: ' . $width . 'px;"' : ''; ?>><?php echo $photo->caption; ?></div>
					<?php } ?>
				<?php if ( ! empty( $link ) ) { ?>
				</a>
				<?php } ?>
