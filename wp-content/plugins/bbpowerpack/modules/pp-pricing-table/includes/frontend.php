			...
			<div class="pp-pricing-table-inner-wrap">
				<div class="pp-pricing-table-header">
					<?php if ( $settings->title_position == 'above' ) { ?>
						<<?php echo $settings->title_tag; ?> class="pp-pricing-table-title"><?php echo isset( $pricing_column->title ) ? $pricing_column->title : ''; ?></<?php echo $settings->title_tag; ?>>
					<?php } ?>
					...
					<?php if ( $settings->title_position == 'below' ) { ?>
						<<?php echo $settings->title_tag; ?> class="pp-pricing-table-title"><?php echo $pricing_column->title; ?></<?php echo $settings->title_tag; ?>>
					<?php } ?>
				</div>
