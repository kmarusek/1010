				...
				'margin' => array(
					...
					'responsive' => array(
						...
						'placeholder'  => array(
							...
							'large'      => array(
								'top'    => empty( $global_settings->module_margins_top_large ) ? $global_settings->module_margins_top : $global_settings->module_margins_top_large,
								'right'  => empty( $global_settings->module_margins_right_large ) ? $global_settings->module_margins_right : $global_settings->module_margins_right_large,
								'bottom' => empty( $global_settings->module_margins_bottom_large ) ? $global_settings->module_margins_bottom : $global_settings->module_margins_bottom_large,
								'left'   => empty( $global_settings->module_margins_left_large ) ? $global_settings->module_margins_left : $global_settings->module_margins_left_large,
							),
							'medium'     => array(
								'top'    => empty( $global_settings->module_margins_top_medium ) ? $global_settings->module_margins_top : $global_settings->module_margins_top_medium,
								'right'  => empty( $global_settings->module_margins_right_medium ) ? $global_settings->module_margins_right : $global_settings->module_margins_right_medium,
								'bottom' => empty( $global_settings->module_margins_bottom_medium ) ? $global_settings->module_margins_bottom : $global_settings->module_margins_bottom_medium,
								'left'   => empty( $global_settings->module_margins_left_medium ) ? $global_settings->module_margins_left : $global_settings->module_margins_left_medium,
							),
							'responsive' => array(
								'top'    => empty( $global_settings->module_margins_top_responsive ) ? $global_settings->module_margins_top_medium : $global_settings->module_margins_top_responsive,
								'right'  => empty( $global_settings->module_margins_right_responsive ) ? $global_settings->module_margins_right_medium : $global_settings->module_margins_right_responsive,
								'bottom' => empty( $global_settings->module_margins_bottom_responsive ) ? $global_settings->module_margins_bottom_medium : $global_settings->module_margins_bottom_responsive,
								'left'   => empty( $global_settings->module_margins_left_responsive ) ? $global_settings->module_margins_left_medium : $global_settings->module_margins_left_responsive,
							),
						),
					),
				),
